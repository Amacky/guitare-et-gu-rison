...
$chrimbo_panels['chrimbo-activities-section'] = array(
...
/*from category  section setting option*/
require get_template_directory() . '/inc/customizer/news-activities/from-category.php';