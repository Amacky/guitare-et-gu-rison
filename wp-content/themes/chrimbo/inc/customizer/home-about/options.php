...
$chrimbo_customizer_defaults['chrimbo-feature-about-event-enable']      = 1;
$chrimbo_customizer_defaults['chrimbo-fs-home-about-button-text']       = esc_html__('KNOW MORE','chrimbo');
$chrimbo_customizer_defaults['chrimbo-about-event-page']                = 0;

/*about event section*/
$chrimbo_sections['chrimbo-feature-about-event-section-options'] = array(
    'priority'       => 10,
    'title'          => esc_html__( 'About-Event Options', 'chrimbo' ),
    'panel'          => 'chrimbo-home-about',
);

/*about event section enable control*/
$chrimbo_settings_controls['chrimbo-feature-about-event-enable'] = array(
    'setting' =>     array(
        'default'              => $chrimbo_customizer_defaults['chrimbo-feature-about-event-enable']
    ),
    'control' => array(
        'label'                 =>  esc_html__( 'Enable About Event', 'chrimbo' ),
        'section'               => 'chrimbo-feature-about-event-section-options',
    	'description'    		=> esc_html__( 'Enable "About Event" on checked' , 'chrimbo' ),
        'type'                  => 'checkbox',
        'priority'              => 5,
        'active_callback'       => ''
    )
...
$chrimbo_settings_controls['chrimbo-fs-home-about-button-text'] = array(
    'setting' =>     array(
        'default'              => $chrimbo_customizer_defaults['chrimbo-fs-home-about-button-text']
    ),
    'control' => array(
        'label'                 =>  esc_html__( 'Botton text', 'chrimbo' ),
        'section'               => 'chrimbo-feature-about-event-section-options',
        'type'                  => 'text',
        'priority'              => 30,
        'active_callback'       => ''
...
$chrimbo_settings_controls['chrimbo-about-event-page'] = array(
    'setting' =>     array(
        'default'              => $chrimbo_customizer_defaults['chrimbo-about-event-page'],
        ),
    'control' => array(
        'label'                 =>  esc_html__( 'Select Page For About Event Section', 'chrimbo' ),
        'description'           => '',
        'section'               => 'chrimbo-feature-about-event-section-options',
        'type'                  => 'dropdown-pages',
        'priority'              => 20
...
$chrimbo_settings_controls['chrimbo-fs-single-words-about'] = array(
    'setting' =>     array(
        'default'              => $chrimbo_customizer_defaults['chrimbo-fs-single-words-about']
    ),
    'control' => array(
        'label'                 =>  esc_html__( 'Single Slider- Number Of Words', 'chrimbo' ),
